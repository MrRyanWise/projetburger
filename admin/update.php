...
{
   $imageError = "Les fichiers sont : .jpg, .jpeg, .png, .gif";
...
if($isUploadSuccess)
{
    ...
    {
        $imageError = "Il ya une erreur lors de l'upload";
        $isUploadSuccess = false; 
    }
}
        }
    ...
    <div class="container admin">
        <div class="row">
            <div class="col-sm-6">
                ...
                <br>
                 <form class="form" method="post" action="<?php echo 'update.php?id=' . $id; ?>" enctype="multipart/form-data"> 
